...
@property (nonatomic, assign) GLuint insectUniform;
...
- (void)commonInit {
    ...
    [self compileShaders];
    [self setupVBO];
    _leafTexture = [self setupTexture:@"leaves.gif" texure:GL_TEXTURE1];
    _insectTexture = [self setupTexture:@"beetle.png" texure:GL_TEXTURE0];
...
- (void)compileShaders {
    ...
    _insectUniform = glGetUniformLocation(programHandle, "InsectTexture");
